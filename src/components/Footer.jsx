...
const Footer = () => {
  return (
    <footer className="mt-screen col-span-full bg-[#6b5f6e] text-black py-[var(--space-s)] px-[var(--space-s)]">
      <div className="flex flex-col max-w-[var(--content-width)] mx-auto sm:flex-row sm:justify-between sm:items-end">
        ...
        <Image src={SMKLogoSort} alt="SMK Logo" width={200} height={60} loading="lazy" />
      </div>
    </footer>
  );
};
